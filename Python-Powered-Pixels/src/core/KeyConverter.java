...
public class KeyConverter {
	...
	public static boolean isKeyDown(String keyCharacter) {
        if (keyCharacter.toLowerCase().equals("enter")) {
            keyCharacter = "return";
        }
        if (keyCharacter.toLowerCase().equals("backspace")) {
            keyCharacter = "back";
        }
        if (keyCharacter.toLowerCase().equals("pageup")) {
            keyCharacter = "prior";
        }
        if (keyCharacter.toLowerCase().equals("pagedown")) {
            keyCharacter = "next";
        }
        if (keyCharacter.toLowerCase().equals("capslock")) {
            keyCharacter = "capital";
        }

        keyCharacter = keyCharacter.replaceAll("windows", "meta");
        keyCharacter = keyCharacter.replaceAll("alt", "menu");

        return Keyboard.isKeyDown(Keyboard.getKeyIndex(keyCharacter.toUpperCase()));
